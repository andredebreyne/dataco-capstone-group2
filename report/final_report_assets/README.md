...
| Table 7. AO3 operational recommendation matrix | `tables/table_7_ao3_operational_recommendation_matrix.md`; `tables/table_7_ao3_operational_recommendation_matrix.csv` | Ready. |

...
| Asset ID | Type | Placeholder | Output path | Source status | Generated status | Ready for main report | Appendix candidate | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| `figure_2_powerbi_dashboard_screenshot` | Figure | Figure 2. Power BI Executive Command Center for DataCo Risk-Margin Prioritization | `figures/figure_2_powerbi_executive_command_center.png`; `figures/DataCo_Dashboard.pdf`; `figures/figure_2_powerbi_dashboard_screenshot_placeholder.md` | `ready` | `ready` | Yes | No | Figure 2 PNG was created from the supplied Page 1 dashboard image export. The PDF remains the dashboard evidence source. No `.pbix` or fake dashboard artifact was created. |

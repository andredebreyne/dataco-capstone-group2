...
This orchestrator covers Bronze, Silver, feature engineering, AO1 Gold table creation, lightweight validation, optional AO1 chronological partition creation, optional EDA artifact checks, and pre-Gold governance checks. Model training, scoring, dashboard exports, and final model evaluation are not part of this workflow.

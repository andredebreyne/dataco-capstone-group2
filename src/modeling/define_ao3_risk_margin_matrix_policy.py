...
def build_policy_row(risk_cutoff: float) -> dict[str, object]:
    ...
    return {
        ...
        "risk_signal_lineage": "Issue #41 AO1 XGBoost predicted probability; AO3 reuses the frozen AO1 output.",
        ...
        "profit_signal_lineage": "Issue #41 AO2 Gradient Boosting predicted order profit; AO3 reuses the frozen AO2 output.",
        "margin_signal_lineage": "Deterministic ratio: ao2_predicted_order_profit divided by ao3_order_value.",
